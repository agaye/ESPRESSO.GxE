#' 
#' @title Simulates the individual effect related to heterogeneity in disease risk
#' @description The variation in baseline disease risk is assumed to be normally distributed on a logistic scale. If this parameter is set to 10, the implication is that a 'high risk' subject (someone at the upper 95 percent centile of population risk) is, all else being equal, at 10 times the offs of developing disease compared to someone else who is at 'low risk' (at the lower 5 percent centile of population risk)
...
sim.subject.data <-
function (num.obs=20000, baseline.OR=12.36) 
{ 					
